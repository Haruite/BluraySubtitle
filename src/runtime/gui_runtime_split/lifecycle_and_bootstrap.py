...
class LifecycleBootstrapMixin(BluraySubtitleGuiBase):
    ...
    def init_ui(self):
        ...
        self.trim_copyright_tail_checkbox = QCheckBox(self.t('Trim copyright bumper'), select_all_tracks_row)
        ...
        self.mux_dolby_vision_checkbox = QCheckBox(self.t('Mux Dolby Vision'), select_all_tracks_row)
        self.mux_dolby_vision_checkbox.setChecked(True)
        select_all_tracks_layout.addWidget(self.mux_dolby_vision_checkbox)
        self.remux_flac_checkbox = QCheckBox(
            self.t('Convert lossless audio to FLAC'), select_all_tracks_row
        )
        self.remux_flac_checkbox.setChecked(True)
        self.remux_flac_checkbox.setVisible(self.get_selected_function_id() == 3)
        select_all_tracks_layout.addWidget(self.remux_flac_checkbox)
