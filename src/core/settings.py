...
DIY_REMUX_LABELS = ["sub_path", "language", "ep_duration", "bdmv_index", "start_at_chapter", "end_at_chapter", "m2ts_file", "play"]
...
DIY_SP_LABELS = ["select", "bdmv_index", "mpls_file", "m2ts_file", "m2ts_type", "duration", "tracks", "vpy_path", "edit_vpy", "preview_script", "play"]
