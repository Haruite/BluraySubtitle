"""Built-in encoder preset parameters shared by the GUI and application settings."""
...
def encode_preset_parameters(encoder: str, preset: str) -> str:
    """Return built-in parameters for a normalized encoder and preset."""
    return ENCODE_PRESET_PARAMETERS.get(
        str(encoder or "").strip().lower(),
